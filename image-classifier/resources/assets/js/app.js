...
async function classifyImage() {
    ...
    document.getElementById('Image__console').innerHTML = `
...
document.getElementById("Button__image").addEventListener("click", function () {
    classifyImage();
});
document.getElementById("Button__webcam").addEventListener("click", function () {
    classifyWebCam();
});